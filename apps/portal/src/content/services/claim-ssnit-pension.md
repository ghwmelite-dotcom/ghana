---
slug: claim-ssnit-pension
title: Claim your SSNIT pension benefit
lifeStage: work
...
eligibility:
  ...
  - text: >-
      You are a surviving dependent of a deceased SSNIT member applying for
      survivors' benefit.
youWillNeed:
  - Ghana Card (original and copy)
  - SSNIT member number and contribution statement
  - Bank account details in your name (Ghana bank only)
  - Birth certificate
  - Two passport photographs
  - For invalidity claims, a medical report from a SSNIT-accredited doctor
cost:
  amount: 0
  currency: GHS
  unit: application
...
applyUrl: https://ssnit.org.gh/claims
...
5. Once approved, your monthly pension is paid directly to your bank account.
