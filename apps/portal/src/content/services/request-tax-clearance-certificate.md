---
slug: request-tax-clearance-certificate
title: Request a tax clearance certificate
lifeStage: work
...
youWillNeed:
  ...
  - Most recent Value Added Tax (VAT) return and receipt (if VAT-registered)
  - PAYE payment schedule (if you employ staff)
cost:
  amount: 0
  currency: GHS
  unit: certificate
...
applyUrl: https://gra.gov.gh/tax-clearance
...
File all outstanding returns and settle any tax debt before submitting your
request. A clearance will not be issued if any undisputed liability is
outstanding.
...
Tax clearance certificates are valid for 6 months from the date of issue.
Present it to the requesting institution (e.g., procurement office, licensing
